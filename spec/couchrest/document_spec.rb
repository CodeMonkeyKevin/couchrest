...
describe CouchRest::Document do
  ...
  describe  "bulk saving" do
    ...
    it "should use the document bulk save cache" do
      ...
      doc.database = @db
      doc.save(true)
      lambda { doc.database.get(doc["_id"]) }.should raise_error(CouchRest::ResourceNotFound)
  ...
  describe "copying a document" do
    ...
    describe "to an existing location" do
      ...
      it "should fail without a rev" do
        lambda{@doc.copy @docid}.should raise_error(CouchRest::RequestFailed)
      end
...
describe "dealing with attachments" do
  ...
  describe "deleting an attachment from a doc directly" do
    ...
    it "removes it" do
      lambda { @db.fetch_attachment(@doc, 'test.html').should }.should raise_error(CouchRest::ResourceNotFound)
    end
