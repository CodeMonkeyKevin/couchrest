...
describe CouchRest::Database do
  ...
  describe "PUT (new document with url id)" do
    it "should create the document" do
      @docid = "http://example.com/stuff.cgi?things=and%20stuff"
      @db.save_doc({'_id' => @docid, 'will-exist' => 'here'})
      lambda{@db.save_doc({'_id' => @docid})}.should raise_error(CouchRest::RequestFailed)
      @db.get(@docid)['will-exist'].should == 'here'
    end
  end
  ...
  describe "PUT (new document with id)" do
    ...
    it "should create the document" do
      ...
      lambda{@db.save_doc({'_id' => 'my-doc'})}.should raise_error(CouchRest::RequestFailed)
    end
  end
  ...
  describe  "UPDATE existing document" do
    ...
    it "should fail if update_limit is reached" do
      ...
      end.should raise_error(CouchRest::RequestFailed)
    end
  ...
  describe "COPY existing document" do
    ...
    describe "to an existing location" do
      ...
      it "should fail without a rev" do
        lambda{@db.copy_doc @doc, @docid}.should raise_error(CouchRest::RequestFailed)
      end
